...
alert((num1 === 1 || num1 < 1) ? `переменная ${num1} равна или меньше 1` : `переменная больше 1`)
let num2 = Number(prompt('Введите число'));
alert((num2 > 3 || num2 === 3) ? `переменная ${num2} больше или равна 3` : `переменная меньше 3`)
...
if (day <= 10) {
    alert(`${day} - относится к первой декаде`)
} else 
if (day >= 11 && day <=20) {
    alert(`${day} - относится ко второй декаде`)
} else {
    alert(`${day} относится к третьей декаде`)
}
